...
const SpotsDetails = () => {
    ...
    const { _id, image, tourists_spot_name, country_Name, average_cost, location, description, travel_time, seasonality, totaVisitorsPerYear, user_email, user_name } = spots;
